  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
        <StatCard label="Present Today"  value="112" delta="of 126 students" deltaColor="text-gray-500"   icon="✅" iconBg="bg-green-50"  />
        <StatCard label="Absent Today"   value="14"  delta="5 notified"      deltaColor="text-red-500"    icon="❌" iconBg="bg-red-50"    />
        <StatCard label="Avg Attendance" value="88%" delta="This month"                                   icon="📊" iconBg="bg-blue-50"   />
        <StatCard label="At Risk"        value="7"   delta="Below 75%"       deltaColor="text-orange-500" icon="⚠️" iconBg="bg-orange-50" />
      </div>

      <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
        <h3 className="text-sm font-bold text-gray-800 mb-4">🔥 Attendance Heatmap — June 2026</h3>
      ...
      <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
        <div className="border-b border-gray-100 px-6 py-4 flex items-center justify-between">
          <h3 className="text-sm font-bold text-gray-800">📋 Today&apos;s Register</h3>
          ...
          <table className="w-full text-sm border-collapse">
            ...
            <tbody className="divide-y divide-gray-100">
              {[
                ...
                { name:"Priya Sharma", grade:9,  checkin:"—",        status:"Absent",  sc:"bg-red-100 text-red-700",     bg:"bg-purple-500"  },

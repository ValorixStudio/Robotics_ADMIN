import { StatCard, ProgressBar } from "@/app/ui";

export default function LearnerProfilePage() {
  return (
    <>
      <h1 className="text-2xl font-bold tracking-tight text-gray-800">Learner Profile — Arjun Patel</h1>
      <p className="text-sm text-gray-500 -mt-4">360° view · STU12345 · Grade 10 · Explorer &amp; Innovator</p>

      <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
        <StatCard label="Overall Score" value="72%" delta="Strong Learner"   deltaColor="text-blue-600"  icon="📈" iconBg="bg-blue-50"   />
        <StatCard label="Accuracy"      value="78%" delta="↑ 3% this month" deltaColor="text-green-600" icon="✅" iconBg="bg-green-50"  />
        <StatCard label="Time Spent"    value="64h" delta="Total learning"                               icon="⏱️" iconBg="bg-orange-50" />
        <StatCard label="Activities"    value="126" delta="Completed tasks"                              icon="📚" iconBg="bg-cyan-50"   />
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
          <h3 className="text-sm font-bold text-gray-800 mb-4">🧠 Cognitive Skills</h3>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
          <h3 className="text-sm font-bold text-gray-800 mb-4">👁️ Learning Style (VARK)</h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm text-center">
          <h3 className="text-sm font-bold text-gray-800 mb-4">⚡ Learning Speed</h3>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
          <h3 className="text-sm font-bold text-gray-800 mb-4">⚠️ Mistake Patterns</h3>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
          ...
          {[
            { emoji:"🤖", label:"Robotics",    value:90, color:"bg-cyan-400"   },
            { emoji:"💻", label:"Coding",      value:85, color:"bg-blue-500"   },
            { emoji:"🧊", label:"Design & 3D", value:75, color:"bg-purple-500" },
            { emoji:"🧠", label:"AI & ML",     value:60, color:"bg-orange-400" },
          ].map(i => (
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
        <h3 className="text-sm font-bold text-gray-800 mb-4">🚀 Personalized Recommendations</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {[
            { emoji:"🎓", color:"text-blue-600",   border:"hover:border-blue-300",   title:"Strengthen Evaluation Skills",  body:"Try activities involving decision-making, comparing options, and justifying solutions." },
            { emoji:"📊", color:"text-cyan-500",   border:"hover:border-cyan-300",   title:"Improve Conceptual Clarity",    body:"Use mind maps and teach-back method to understand the 'why' behind concepts." },
            { emoji:"🚀", color:"text-orange-500", border:"hover:border-orange-300", title:"Career Path",                   body:"Robotics Engineer / Product Designer / AI Developer — best match for your strengths." },
          ].map(r => (

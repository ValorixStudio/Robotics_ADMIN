    ...
    <>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white border-2 border-green-200 rounded-xl p-6 shadow-sm">
          ...
          <button className="w-full py-2 rounded-xl bg-green-500 hover:bg-green-600 text-white text-xs font-semibold transition-colors">Join Class →</button>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
          ...
          <div className="text-base font-bold text-gray-800 mb-1">Electronics — Ohm&apos;s Law</div>
          <div className="text-xs text-gray-400 mb-4">Mr. Singh · Jun 9, 2:00 PM · 58 min</div>
          <button className="w-full py-2 rounded-xl border border-gray-200 text-gray-600 text-xs font-semibold hover:bg-gray-50 transition-colors">▶ Watch Recording</button>
        </div>
      </div>
    </>
  );

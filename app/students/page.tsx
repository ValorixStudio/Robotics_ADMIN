            ...
            <tbody className="divide-y divide-gray-100">
              {[
                ...
                <tr key={s.id} className="hover:bg-gray-50/50">
                  ...
                  <td className="p-4">
                    <Link href="/admin/learnerprofile" className="px-3 py-1.5 rounded-lg border border-gray-200 text-xs text-gray-600 hover:bg-gray-50 transition-colors">Profile</Link>
                  </td>
                </tr>
              ))}
            </tbody>

...
const NAV_GROUPS: NavGroup[] = [
  {
    ...
    icon: "book",
    items: [
      { id: "courses", label: "Courses", icon: "course", href: "/courses", badge: "" },
      { id: "curriculum", label: "Curriculum", icon: "clipboard", href: "/curriculum" },
      { id: "assignments", label: "Assignments", icon: "file", href: "/assignments", badge: "" },
      { id: "tutorials", label: "Tutorials", icon: "book", href: "/tutorials" },
      { id: "quizzes", label: "Quizzes", icon: "quiz", href: "/quizzes" },
      { id: "quiz-review", label: "Quiz Review", icon: "grade", href: "/quiz-review" },
      { id: "liveclass", label: "Live Classes", icon: "video", href: "/liveclass", badge: "" },

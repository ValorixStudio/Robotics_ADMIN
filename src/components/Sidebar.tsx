...
const NAV_SECTIONS: { label: string; items: NavItem[] }[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "3d-models", label: "3D Models", icon: "📦", href: "/3d_model",     badge: "Library" },
    ],
  },
  {
    label: "Admin",
            ...
            <div key={section.label} className="mb-1">
              ...
              {section.items.map(item => (
                <NavLink
                  ...
                  to={item.href}
                  className={({ isActive }) =>
                    `block w-full flex items-center gap-[9px] px-[18px] py-[10px] text-xs font-semibold border-l-4 transition-all ${
                      isActive

export default function AdminProfilePage() {
  return (
    <>
      <div>
        <p className="text-[11px] font-bold uppercase tracking-[0.18em] text-[#006aa0]">My account</p>
      ...
      <div className="grid gap-6 lg:grid-cols-[320px_minmax(0,1fr)]">
        <section className="rounded-2xl border border-gray-200 bg-white p-6 text-center shadow-sm">
          <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-2xl bg-[#006aa0] text-2xl font-bold text-white shadow-sm">A</div>
          <h2 className="mt-4 text-lg font-bold text-gray-900">Admin User</h2>
          <p className="mt-1 text-xs text-gray-400">admin@circuitstudio.com</p>
        ...
        <section className="rounded-2xl border border-gray-200 bg-white shadow-sm">
          ...
          <div className="grid gap-5 p-6 sm:grid-cols-2">
            {[
              ...
              ["Email address", "admin@circuitstudio.com"],
              ["Role", "Super Admin"],
              ["Organization", "Circuit Studio"],

      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex gap-1">
              <button className="px-2.5 py-1.5 rounded-lg border border-gray-200 text-xs text-gray-600 hover:bg-gray-50 transition-colors">ΓÇ╣</button>
              <button className="px-2.5 py-1.5 rounded-lg border border-gray-200 text-xs text-gray-600 hover:bg-gray-50 transition-colors">ΓÇ║</button>
            </div>
          </div>
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
          ...
          {[
            ...
            { icon:"Γ¥ô", iconBg:"bg-amber-50", title:"Algebra Quiz",              sub:"Jun 14, 10:00 AM",      tag:"Upcoming", tagC:"bg-amber-100 text-amber-700" },
            { icon:"≡ƒôï", iconBg:"bg-red-50",   title:"Mid-term Exams Start",      sub:"Jun 18 ΓÇö Jun 22",       tag:"Exam Week",tagC:"bg-red-100 text-red-700"    },
          ].map(ev => (

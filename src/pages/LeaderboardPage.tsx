      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-sm font-bold text-gray-800">=É≈Â Overall Rankings</h3>
          ...
          {[
            { rank:"=É—Á", name:"Arjun Patel",  sub:"Robotics -+ Coding",   score:"2,840 pts", bg:"bg-indigo-500"  },
            { rank:"=É—Í", name:"Rohit Kumar",  sub:"Python -+ Electronics", score:"2,610 pts", bg:"bg-emerald-500" },
            { rank:"=É—Î", name:"Priya Sharma", sub:"Coding",               score:"2,205 pts", bg:"bg-purple-500"  },
            ...
            <div key={s.name} className="flex items-center gap-3 py-3 border-b border-gray-100 last:border-0">
              ...
              <span className="text-sm font-bold text-[#e51b72] font-mono">{s.score}</span>
            </div>
          ))}
        </div>

        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
          <h3 className="text-sm font-bold text-gray-800 mb-4">=Éƒ˚n+≈ Badges Earned</h3>
          <div className="grid grid-cols-3 gap-3">
            {[
              { emoji:"=ÉÒ˚", label:"Bot Builder",   locked:false },
              { emoji:"=Éˆ—", label:"7-Day Streak",  locked:false },
              { emoji:"=É∫·", label:"Top Thinker",   locked:false },
              { emoji:"G‹Ì", label:"Fast Finisher", locked:false },
              { emoji:"=É≈‡", label:"Locked",        locked:true  },
              { emoji:"=ÉÓÉ", label:"Locked",        locked:true  },
            ].map(b => (

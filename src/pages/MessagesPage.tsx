    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
          ...
          {[
            { from:"Arjun Patel",  preview:"Sir, I have a doubt in Module 3 assignmentGÇª",   time:"2m ago",    bg:"bg-indigo-500"  },
        ...
        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm flex flex-col gap-4">
          <h3 className="text-sm font-bold text-gray-800">=ƒÆ¼ Arjun Patel GÇö Thread</h3>
          ...
          <div className="bg-blue-50 border border-blue-100 rounded-xl px-4 py-3 text-xs text-blue-800 leading-relaxed ml-5">
            Hi Arjun! Use the Servo.h library GÇö it simplifies PWM handling. Check the example in Module 2 resources. Let me know if still stuck.
          </div>
          <div className="flex gap-2 mt-auto">
            <input className="flex-1 bg-gray-50 border border-gray-200 rounded-xl px-3 py-2.5 text-xs text-gray-800 outline-none focus:border-[#e51b72] transition-colors" placeholder="Type a replyGÇª" />

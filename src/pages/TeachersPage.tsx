        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm border-collapse">
            ...
            <tbody className="divide-y divide-gray-100">
              {[
                { name:"Ms. Kapoor", subject:"Robotics",    courses:2, students:48, rating:"Γ¡É 4.8", status:"Active",  stC:"bg-green-100 text-green-700", bg:"bg-blue-500"   },
                { name:"Mr. Sharma", subject:"Programming", courses:1, students:36, rating:"Γ¡É 4.6", status:"Active",  stC:"bg-green-100 text-green-700", bg:"bg-green-500"  },
                { name:"Dr. Verma",  subject:"AI & ML",     courses:1, students:0,  rating:"Γ¡É ΓÇö",   status:"Pending", stC:"bg-amber-100 text-amber-700", bg:"bg-purple-500" },
              ].map(t => (
